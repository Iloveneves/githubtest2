...
#ifndef __HI_PVR_API_H__
#define __HI_PVR_API_H__
...
typedef struct hiPVR_REC_ATTR_S
{
    ...
    HI_U32               u32UsrDataInfoSize;                    /* manage info for user(save to idx file) */
    ...
    HI_U64               u64MaxFileSize;                        /* 0 means no limit, else limit the size */
    HI_BOOL              bRewind;                               /* TRUE: rewind; */
...
/* pvr index save structure description                                     */
typedef struct hiPVR_INDEX_ENTRY_S
{
    ...
    HI_U32 u32SeqHeadSize;                        /* last seqHead size, byte   */
    HI_U64 u64SeqHeadOffset;                      /* last seqHead offset, byte */
    HI_U32 u32DisplaySeq;                         /* display sequence */
    HI_U32 u32FrameSize;                          /* frame size */
    HI_U64 u64Offset;                             /* offset of frame at stream file */
    HI_U32 u32Clock;                              /* pts of ms */  
    HI_U16 u16IndexType;                          /* index type   */         
    HI_U16 u161stFrameOfTT;                       /*  */         
...
HI_S32 HI_PVR_RecNewChn(HI_U32 *pu32ChnID, const PVR_REC_ATTR_S *pstRecAttr);
HI_S32 HI_PVR_RecFreeChn(HI_U32 u32ChnID);

/* set and get attributes of record channel                                 */
HI_S32 HI_PVR_RecSetChn(HI_U32 u32ChnID, const PVR_REC_ATTR_S *pstRecAttr);
HI_S32 HI_PVR_RecGetChn(HI_U32 u32ChnID, PVR_REC_ATTR_S *pstRecAttr);
...
/* get record status                                                        */
HI_S32 HI_PVR_RecGetStatus(HI_U32 u32ChnID, PVR_REC_STATUS_S *pstRecStatus);
...
HI_S32 HI_PVR_PlayNewChn(HI_U32 *pu32ChnID, const PVR_PLAY_ATTR_S *pstPlayAttr);
HI_S32 HI_PVR_PlayFreeChn(HI_U32 u32ChnID);

/* start and stop time shift                                                */
HI_S32 HI_PVR_PlayStartTimeShift(HI_U32 *pu32PlayChnID, HI_U32 u32DemuxID, HI_U32 u32RecChnID);
HI_S32 HI_PVR_PlayStopTimeShift(HI_U32 u32PlayChnID);

/* set and get attributes of play channel                                   */
HI_S32 HI_PVR_PlaySetChn(HI_U32 u32ChnID, const PVR_PLAY_ATTR_S *pstPlayAttr);
HI_S32 HI_PVR_PlayGetChn(HI_U32 u32ChnID, PVR_PLAY_ATTR_S *pstPlayAttr);

/* start and stop play channel                                              */
HI_S32 HI_PVR_PlayStartChn(HI_U32 u32ChnID);
HI_S32 HI_PVR_PlayStopChn(HI_U32 u32ChnID);
...
/* get play status                                                          */
HI_S32 HI_PVR_PlayGetStatus(HI_U32 u32ChnID, PVR_PLAY_STATUS_S *pstStatus);

/* locate play position                                                     */
HI_S32 HI_PVR_PlaySeek(HI_U32 u32ChnID, const PVR_PLAY_POSITION_S *pstPosition);

/* start trick mode of playing                                              */
HI_S32 HI_PVR_PlayTrickMode(HI_U32 u32ChnID, const PVR_PLAY_MODE_S *pstTrickMode);

/* start step back frame by frame                                           */
HI_S32 HI_PVR_PlayStep(HI_U32 u32ChnID, HI_S32 s32Direction);

/* get file info */
HI_S32 HI_PVR_PlayGetFileAttr(HI_U32 u32ChnID, PVR_FILE_ATTR_S *pAttr);

/* get file attr, no need to new play channel */
HI_S32 HI_PVR_GetFileAttrByFileName(const HI_CHAR *pFileName, PVR_FILE_ATTR_S *pAttr);
...
HI_S32 HI_PVR_RegisterEvent(PVR_EVENT_E enEventType, eventCallBack callBack, HI_VOID *args);

/* we adapt macro define for unregister function, it'll cut code scale.     */
#define HI_PVR_UnRegisterEvent(enEventType) HI_PVR_RegisterEvent(enEventType, HI_NULL_PTR, HI_NULL_PTR)

HI_S32 HI_PVR_CreateIdxFile(HI_U8* pstTsFileName, HI_U8* pstIdxFileName, PVR_GEN_IDX_ATTR_S* pAttr);

HI_VOID HI_PVR_ConfigDebugInfo(HI_U32 u32DebugLevel);

HI_VOID HI_PVR_RemoveFile(const HI_CHAR *pFileName);

/* PVR file structure ******************************************************
  
├─include                         --- X5 public api header
├─pvr
    ├─api
    │  ├─include                 --- PVR inter module header
    │  └─src
    ├─drv     
    ├─sample     
    └─test
...
#endif /* End of #ifndef __HI_PVR_API_H__ */
