...
/*****************************************************************************
* Function:      HI_TDE2_Rotate
* Description:   将源位图操作区域旋转一定角度后输出到目标位图的起始点(s32PointX, s32PointY)开始的位置上
* Input:         s32Handle: 任务句柄
*                pstSrc:源位图
*                pstSrcRect:源位图操作区域
*                pstDst:目标位图
*                s32DstPointX: 旋转后输出到目标位图的位置的X坐标
*                s32DstPointY: 旋转后输出到目标位图的位置的Y坐标
*                enRotateAngle:旋转角度
÷* Output:        无
* Return:        0:成功; <0: 错误码
* Others:        源位图和目标位图的象素格式必须一致；只有在整幅图象旋转时才支持源位图和目标位图相同
*****************************************************************************/
